package global.skymind.character;
...
/**
 ...
 Trains a LSTM RNN to generates text, one character at a time.
 ...
 The model is then asked to generate text on its own provided with a seed of text.
